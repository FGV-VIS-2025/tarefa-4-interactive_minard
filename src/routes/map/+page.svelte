<script>
    ...
    import worldTopojson from "$lib/data/world-atlas-50m.json"; // You'll need to download this file
    ...
    // Map region bounds - defined directly from data
    const minLat = 54.05;
    const maxLat = 55.96;
    const minLong = 22;
    const maxLong = 38;
    ...
    onMount(() => {
        ...
        // Filter to only the countries we're interested in
        ...
        // Create a group for the map that will be drawn before army circles
        // Insert it before armies-group to ensure it's in the background
        ...
        // Add country borders - this creates a subtle grid effect
